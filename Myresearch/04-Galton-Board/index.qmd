...
For consistency, a LEGO grid identical to the one used in the simulation has been employed


![](Image/01Plinkoo_2.png){group="elsewhere"}

You can compare the simulation results with the empirical data presented below.

![](Image/Asset 3-20.jpg){group="elsewhere"}

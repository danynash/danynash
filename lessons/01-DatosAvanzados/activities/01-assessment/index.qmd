...
Realice una prueba que permita evidenciar si existen diferencias significativas entre el puntaje promedio del `juez_1` y el `juez_2`. Reporte sus resultados en una tabla y junto a la tabla el reporte verbal. Puede guiarse por la norma APA 7 en el título que indica [`Sample results of several t tests table`](https://apastyle.apa.org/style-grammar-guidelines/tables-figures/sample-tables). Para el reporte, utilice el usado en la [`Clase 4, p.60`](https://cursos.canvas.uc.cl/courses/101869/modules/items/3021636) del curso.
...
En base a los resultados obtenidos,  justifique si rechaza la hipótesis nula e integre en su respuesta el nivel de confianza usado para sustentar su afirmación.

## Pregunta 2.4:

Realice ahora un test de ANOVA y reporte sus resultados en una tabla y verbalmente. Utilice como referencia la tabla ANOVA y el report usado en la Clase 5 del curso. Luego, compare los resultados de la prueba de ANOVA con los resultados de la prueba t realizada anteriormente ¿Qué puede concluir? 

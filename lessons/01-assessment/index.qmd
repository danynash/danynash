...
Realice una tabla con estadísticos descriptivo. Puede guiarse por APA 7, vea ejemplo a continuación para reportar.
...
Realice una prueba que permita evidenciar si existen diferencias significativas entre el puntaje promedio del `juez_1` y el `juez_2`. Reporte sus resultados en una tabla y junto a la tabla el reporte verbal. Puede guiarse por la norma APA 7 en el título que indica [`Sample results of several t tests table`](https://apastyle.apa.org/style-grammar-guidelines/tables-figures/sample-tables). Para el reporte, utilice el usado en la [`Clase 5, p.13`](https://cursos.canvas.uc.cl/courses/73437/modules/items/2048324) del curso.
...
Realice ahora un test de ANOVA y reporte sus resultados en una tabla y verbalmente. Utilice como referencia la tabla ANOVA usada en [`Clase 5`](https://cursos.canvas.uc.cl/courses/73437/modules/items/2048324) del curso.
